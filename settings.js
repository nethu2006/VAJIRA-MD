...
global.owner = [process.env.OWNER_NUMBER] || ['94773913394'] // Owner number , (අයිතිකරුගේ නම්බර් එක )

module.exports = {    
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD:InformSleeding',
...
OWNER_NUMBER: process.env.OWNER_NUMBER || '94773913394'  ,    
ALIVE: process.env.ALIVE || `default`,
OWNER_NAME: process.env.OWNER_NAME || 'Thaviya' ,     
